...
class EmployeeTable(BaseTable, table=True):
    """Employee Table."""
    ...
    supervised_jobs: list["JobCardTable"] = Relationship(  # type: ignore
        back_populates="supervisor",
        sa_relationship_kwargs={"foreign_keys": "JobCardTable.supervisor_id"},
    )
    mechanic_jobs: list["JobCardTable"] = Relationship(  # type: ignore
